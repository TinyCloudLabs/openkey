...
- 19b612d: Capture and verify the previous Better Auth session without refreshing it
  ...
  state.
- 0254be9: Add `OpenKey.signOut()` for correlated OpenKey-widget session revocation and
  local SDK session cleanup, enabling applications to switch OpenKey accounts
  without implementing the auth protocol themselves.
