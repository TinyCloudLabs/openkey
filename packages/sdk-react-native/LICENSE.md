...
**Licensed Work:** OpenKey React Native SDK
...
**Transition License:** AGPL-3.0-or-later

**TinyCloud Network:** The TinyCloud ecosystem encompasses decentralized storage protocols,
user-owned data namespace systems, and platforms utilizing decentralized
identifiers (DIDs), delegation chains, and object capability (OCAP)
...
On the Transition Date, the Licensed Work automatically becomes available under the Transition License. Additionally, production use on the TinyCloud Network and TinyCloud-Aligned Networks becomes freely permitted (subject to copyleft requirements in Section 3).

At all times (before and after the Transition Date), production use on Non-TinyCloud-Aligned Networks (networks that do not meet the TinyCloud-Aligned criteria) requires a separate commercial license from the Licensor.

Production use generating more than 100000 USD in annual recurring revenue requires a commercial license from the Licensor, regardless of TinyCloud alignment status.
...
This License does not grant rights to trademarks, logos, or tokens associated with the Licensor or TinyCloud.
...
**"TinyCloud Network"** means The TinyCloud ecosystem encompasses decentralized storage protocols,
user-owned data namespace systems, and platforms utilizing decentralized
identifiers (DIDs), delegation chains, and object capability (OCAP)
authorization models for secure, user-controlled data management.
.
...
**"Non-TinyCloud-Aligned Network"** means Systems that provide similar functionality for decentralized storage,
namespace management, or DID-based authorization that do not integrate
with or contribute to the TinyCloud ecosystem.
.
...
- Non-commercial production use on TinyCloud or aligned networks
...
- **TinyCloud-Aligned Production Use:** You may make Production Use of the Licensed Work on the TinyCloud Network and TinyCloud-Aligned Networks without restriction, royalty, or commercial license, subject to the copyleft requirements in Section 3.
- **Prior Restrictions Lifted:** The early-stage production restrictions in Section 2.2 cease to apply, except as noted in Sections 2.5 and 2.6.

#### 2.5 Non-TinyCloud-Aligned Network Restriction (Permanent)

At all times, both before and after the Transition Date, Production Use on Non-TinyCloud-Aligned Networks requires a separate commercial license from the Licensor.

The Transition Date conversion does not grant rights to deploy the Licensed Work on Non-TinyCloud-Aligned Networks. Such use requires explicit commercial licensing regardless of when it occurs.

#### 2.6 Revenue Threshold

Production use generating more than 100000 USD in annual recurring revenue requires a commercial license from the Licensor, regardless of TinyCloud alignment status.

#### 2.7 Version-Specific Licensing
...
- **Under This License:** Available under this License's terms (before Transition Date) or Transition License terms (after Transition Date)
...
You are encouraged (though not required before the Transition Date) to contribute improvements back to the original project or the TinyCloud community.
...
The Non-TinyCloud-Aligned Network restriction in Section 2.5 and the Revenue Threshold in Section 2.6 persist as separate commercial licensing arrangements at the Licensor's discretion.
...
- Deploy on a Non-TinyCloud-Aligned Network without a commercial license (Section 2.5)
- Exceed the Revenue Threshold without a commercial license (Section 2.6)
...
This License does not grant rights to use trademarks, logos, or brand names of the Licensor or TinyCloud. You may not imply endorsement by the Licensor or the TinyCloud community.

This License does not grant rights to any tokens or cryptocurrencies associated with the Licensed Work or TinyCloud.
...
This License is governed by the laws of the jurisdiction in which the Licensor is incorporated, without regard to conflicts of law principles.
...
- Do not alter the substantive terms, alignment provisions, or copyleft requirements
...
- Use an appropriate name that reflects the ecosystem they are targeting

## Covenants of Licensor

In consideration of the right to use this License text, Licensor covenants to all recipients of the Licensed Work:
...
- Not to modify the substantive protections, requirements, or structure of this License in ways that would defeat its purpose of protecting ecosystem alignment while ensuring eventual open-source release.
...
This license is derived from the Ethereum General Public License (EGPL) v1.5 by Lighthouse Labs.
Original EGPL: Ethereum General Public License (EGPL) v1.5

For more information, visit [Lighthouse Labs](https://lighthouse.cx).
