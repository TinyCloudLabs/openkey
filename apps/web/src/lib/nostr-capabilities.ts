...
export const NOSTR_KIND_COPY: Record<number, { title: string; description: string; sensitive?: boolean }> = {
  ...
  9001: { title: 'Remove channel members', description: 'Remove someone from a channel you help run.', sensitive: true },
  9002: { title: 'Edit channel settings', description: 'Change a channel’s name, topic, or visibility.' },
  9007: { title: 'Create channels', description: 'Create new channels in your community.' },
  9021: { title: 'Join channels', description: 'Request to join a channel.' },
